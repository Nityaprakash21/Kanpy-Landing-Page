...
const AISystems: React.FC = () => {
  ...
  const gpts = [
    {
      title: "Brand Voice GPT",
      description: "Trained on your unique philosophy to ensure 100% messaging consistency across all platforms.",
      icon: <MessageSquare className="w-5 h-5" />,
      tag: "Consistency"
    },
    {
      title: "GTM Strategist",
      description: "Proprietary models that analyze market gaps and generate launch frameworks in seconds.",
      icon: <Search className="w-5 h-5" />,
      tag: "Strategy"
    },
    {
      title: "Content Weaver",
      description: "Transforms founder transcripts into high-signal LinkedIn threads and thought leadership articles.",
